...
// Server-side (CloudFlare Workers) PDF builders - use these in route handlers
// and for email attachments. Do NOT use generateQuotePDFBlob on the server: it
// emits a 3-line placeholder document, and generateQuotePDFDataURL calls
// FileReader, which does not exist on Workers.
export { buildQuotePDF, buildQuotePDFBase64 } from './server/buildQuotePDF'
export { buildInvoicePDF, buildInvoicePDFBase64 } from './server/buildInvoicePDF'
