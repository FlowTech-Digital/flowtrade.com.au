...
export default function CreateInvoicePage() {
  ...
  const selectJob = (job: Job) => {
    const lineItems = job.quoted_total ? [
      { id: generateLineItemId(), description: `Job ${job.job_number} - Work Completed`, quantity: 1, unit_price: job.quoted_total, amount: job.quoted_total }
    ] : formData.line_items
    ...
    <div>
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-gray-400 mt-1">Create a new invoice for a customer</p>
        </div>
      </div>
